...
async def test_handlers_surface():
    ...
    # /start onboarding message opens straight with the title — no "Salom" greeting
    import inspect
    ...
    t("handlers", "cmd_start drops the 'Salom! 👋' greeting and keeps the title",
      salom_idx == -1 and title_idx != -1)
