...
Bu modul — Marketing Hub konfiguratsiyasining YAGONA HAQIQAT MANBAI (backend).
`webapp_static/index.html` ichidagi JS config bloki bu fayl bilan LOCKSTEP saqlanadi;
biri o'zgarsa — ikkinchisi ham. `tests/marketing_hub_check.py` regex bilan
`WORKFLOWS`/`TEMPLATES` kalitlarini taqqoslab drift'ni ushlaydi.
